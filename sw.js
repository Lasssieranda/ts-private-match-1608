const CACHE = 'tiefstapel-heart-v6';
const SHELL = ['./','index.html','styles.css','online.css','src/app.js?v=034','src/engine.js?v=034','src/online.bundle.js?v=034','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png'];
