const CACHE = 'tiefstapel-heart-v13';
const SHELL = ['./','index.html','styles.css?v=041','online.css?v=041','src/app.js?v=041','src/engine.js?v=041','src/online.bundle.js?v=041','manifest.webmanifest?v=041','icons/icon-192.png?v=041','icons/icon-512.png?v=041'];
