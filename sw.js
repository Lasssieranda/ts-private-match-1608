const CACHE = 'tiefstapel-heart-v4';
const SHELL = ['./','index.html','styles.css','online.css','src/app.js','src/engine.js','src/online.bundle.js?v=032','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png'];
