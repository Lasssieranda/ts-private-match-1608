const CACHE = 'tiefstapel-heart-v3';
const SHELL = ['./','index.html','styles.css','online.css','src/app.js','src/engine.js','src/online.bundle.js?v=031','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png'];
