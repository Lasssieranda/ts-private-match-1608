const CACHE = 'tiefstapel-heart-v7';
const SHELL = ['./','index.html','styles.css','online.css','src/app.js?v=035','src/engine.js?v=035','src/online.bundle.js?v=035','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png'];
